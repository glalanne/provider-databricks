...
func (mg *PostgresBranch) ResolveReferences( // ResolveReferences of this PostgresBranch.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("postgres.databricks.m.crossplane.io", "v1beta1", "PostgresProject", "PostgresProjectList")
		if err != nil {
...
func (mg *PostgresCdfConfig) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("postgres.databricks.m.crossplane.io", "v1beta1", "PostgresDatabase", "PostgresDatabaseList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *PostgresDatabase) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("postgres.databricks.m.crossplane.io", "v1beta1", "PostgresBranch", "PostgresBranchList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
