...
type LibraryInitParameters_2 struct {
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/storage/v1alpha2.DbfsFile
	...
	// +kubebuilder:validation:Optional
	EggRef *v1.NamespacedReference `json:"eggRef,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/storage/v1alpha2.File
	...
	// +kubebuilder:validation:Optional
	JarRef *v1.NamespacedReference `json:"jarRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	WhlRef *v1.NamespacedReference `json:"whlRef,omitempty" tf:"-"`
