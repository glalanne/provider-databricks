...
// ConvertTo converts this DatabaseInstance to the hub type.
func (tr *DatabaseInstance) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the DatabaseInstance type.
func (tr *DatabaseInstance) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
