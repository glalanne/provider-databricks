...
func (in *DashboardInitParameters) DeepCopyInto(out *DashboardInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]DashboardProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DashboardObservation) DeepCopyInto(out *DashboardObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]DashboardProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DashboardParameters) DeepCopyInto(out *DashboardParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]DashboardProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *QueryInitParameters) DeepCopyInto(out *QueryInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]QueryProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *QueryObservation) DeepCopyInto(out *QueryObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]QueryProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *QueryParameters) DeepCopyInto(out *QueryParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]QueryProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLAlertInitParameters) DeepCopyInto(out *SQLAlertInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLAlertProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLAlertObservation) DeepCopyInto(out *SQLAlertObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLAlertProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLAlertParameters) DeepCopyInto(out *SQLAlertParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLAlertProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLDashboardInitParameters) DeepCopyInto(out *SQLDashboardInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLDashboardProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLDashboardObservation) DeepCopyInto(out *SQLDashboardObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLDashboardProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLDashboardParameters) DeepCopyInto(out *SQLDashboardParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLDashboardProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLEndpointInitParameters) DeepCopyInto(out *SQLEndpointInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLEndpointProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLEndpointObservation) DeepCopyInto(out *SQLEndpointObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLEndpointProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLEndpointParameters) DeepCopyInto(out *SQLEndpointParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLEndpointProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLGlobalConfigInitParameters) DeepCopyInto(out *SQLGlobalConfigInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLGlobalConfigProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLGlobalConfigObservation) DeepCopyInto(out *SQLGlobalConfigObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLGlobalConfigProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLGlobalConfigParameters) DeepCopyInto(out *SQLGlobalConfigParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLGlobalConfigProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLQueryInitParameters) DeepCopyInto(out *SQLQueryInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLQueryProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLQueryObservation) DeepCopyInto(out *SQLQueryObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLQueryProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLQueryParameters) DeepCopyInto(out *SQLQueryParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLQueryProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLVisualizationInitParameters) DeepCopyInto(out *SQLVisualizationInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLVisualizationProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLVisualizationObservation) DeepCopyInto(out *SQLVisualizationObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLVisualizationProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLVisualizationParameters) DeepCopyInto(out *SQLVisualizationParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLVisualizationProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLWidgetInitParameters) DeepCopyInto(out *SQLWidgetInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLWidgetProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLWidgetObservation) DeepCopyInto(out *SQLWidgetObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLWidgetProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SQLWidgetParameters) DeepCopyInto(out *SQLWidgetParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]SQLWidgetProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
