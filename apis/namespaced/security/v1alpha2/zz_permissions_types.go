...
type AccessControlInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/security/v1alpha2.Group
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/security/v1alpha2.ServicePrincipal
...
type PermissionsInitParameters struct {
	...
	// cluster id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/compute/v1alpha2.Cluster
	...
	// cluster policy id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/compute/v1alpha2.ClusterPolicy
	...
	// Canonical unique identifier for the permissions in form of /<object type>/<object id>.
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/sql/v1alpha2.Dashboard
	...
	// directory id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/workspace/v1alpha2.Directory
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/mlflow/v1alpha2.MlflowExperiment
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// instance pool id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/compute/v1alpha2.InstancePool
	...
	// job id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/compute/v1alpha2.Job
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/workspace/v1alpha2.Notebook
	...
	// pipeline id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/compute/v1alpha2.Pipeline
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/mlflow/v1alpha2.MlflowModel
	...
	// repo id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/workspace/v1alpha2.Repo
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// SQL alert id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/sql/v1alpha2.SQLAlert
	...
	// SQL dashboard id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/sql/v1alpha2.SQLDashboard
	...
	// SQL warehouse id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/sql/v1alpha2.SQLEndpoint
	...
	// SQL query id
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/sql/v1alpha2.SQLQuery
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/serving/v1alpha2.ModelServing
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/mosaic/v1alpha2.VectorSearchEndpoint
	...
	// Canonical unique identifier for the permissions in form of /<object type>/<object id>.
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/namespaced/workspace/v1alpha2.WorkspaceFile
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("object_id",false)
