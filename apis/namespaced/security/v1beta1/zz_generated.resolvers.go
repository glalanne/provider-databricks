...
import (
	...
	v1beta14 "github.com/glalanne/provider-databricks/apis/namespaced/mlflow/v1beta1"
	v1beta16 "github.com/glalanne/provider-databricks/apis/namespaced/mosaic/v1beta1"
	v1beta15 "github.com/glalanne/provider-databricks/apis/namespaced/serving/v1beta1"
	v1beta12 "github.com/glalanne/provider-databricks/apis/namespaced/sql/v1beta1"
	v1beta13 "github.com/glalanne/provider-databricks/apis/namespaced/workspace/v1beta1"
	errors "github.com/pkg/errors"
	client "sigs.k8s.io/controller-runtime/pkg/client"
)

// ResolveReferences of this AccessControlRuleSet.
func (mg *AccessControlRuleSet) ResolveReferences(ctx context.Context, c client.Reader) error {
...
func (mg *GroupInstanceProfile) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta1.InstanceProfileList{},
			Managed: &v1beta1.InstanceProfile{},
		},
	})
	if err != nil {
...
func (mg *Permissions) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta11.ClusterPolicyList{},
			Managed: &v1beta11.ClusterPolicy{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta12.DashboardList{},
			Managed: &v1beta12.Dashboard{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta13.DirectoryList{},
			Managed: &v1beta13.Directory{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta14.MlflowExperimentList{},
			Managed: &v1beta14.MlflowExperiment{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta11.InstancePoolList{},
			Managed: &v1beta11.InstancePool{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta11.JobList{},
			Managed: &v1beta11.Job{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta13.NotebookList{},
			Managed: &v1beta13.Notebook{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta11.PipelineList{},
			Managed: &v1beta11.Pipeline{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta14.MlflowModelList{},
			Managed: &v1beta14.MlflowModel{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta13.RepoList{},
			Managed: &v1beta13.Repo{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta12.SQLAlertList{},
			Managed: &v1beta12.SQLAlert{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta12.SQLDashboardList{},
			Managed: &v1beta12.SQLDashboard{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta12.SQLEndpointList{},
			Managed: &v1beta12.SQLEndpoint{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta12.SQLQueryList{},
			Managed: &v1beta12.SQLQuery{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta15.ModelServingList{},
			Managed: &v1beta15.ModelServing{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta16.VectorSearchEndpointList{},
			Managed: &v1beta16.VectorSearchEndpoint{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &v1beta13.WorkspaceFileList{},
			Managed: &v1beta13.WorkspaceFile{},
		},
	})
	if err != nil {
