...
func (mg *AccessControlRuleSet) ResolveReferences( // ResolveReferences of this AccessControlRuleSet.
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.GrantRules); i3++ {
		{
			m, l, err = apisresolver.GetManagedResource("security.databricks.m.crossplane.io", "v1beta1", "Group", "GroupList")
			if err != nil {
...
func (mg *GroupInstanceProfile) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("deployment.databricks.m.crossplane.io", "v1beta1", "InstanceProfile", "InstanceProfileList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *MwsPermissionAssignment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("deployment.databricks.m.crossplane.io", "v1beta1", "MwsWorkspaces", "MwsWorkspacesList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *OboToken) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("security.databricks.m.crossplane.io", "v1beta1", "ServicePrincipal", "ServicePrincipalList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Permissions) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("apps.databricks.m.crossplane.io", "v1beta1", "App", "AppList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
	...
	{
		m, l, err = apisresolver.GetManagedResource("compute.databricks.m.crossplane.io", "v1beta1", "ClusterPolicy", "ClusterPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("sql.databricks.m.crossplane.io", "v1beta1", "Dashboard", "DashboardList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("workspace.databricks.m.crossplane.io", "v1beta1", "Directory", "DirectoryList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("mlflow.databricks.m.crossplane.io", "v1beta1", "MlflowExperiment", "MlflowExperimentList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("compute.databricks.m.crossplane.io", "v1beta1", "InstancePool", "InstancePoolList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("ai.databricks.m.crossplane.io", "v1beta1", "KnowledgeAssistant", "KnowledgeAssistantList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("mlflow.databricks.m.crossplane.io", "v1beta1", "MlflowModel", "MlflowModelList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("workspace.databricks.m.crossplane.io", "v1beta1", "Repo", "RepoList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("serving.databricks.m.crossplane.io", "v1beta1", "ModelServing", "ModelServingList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("ai.databricks.m.crossplane.io", "v1beta1", "SupervisorAgent", "SupervisorAgentList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("mosaic.databricks.m.crossplane.io", "v1beta1", "VectorSearchEndpoint", "VectorSearchEndpointList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("workspace.databricks.m.crossplane.io", "v1beta1", "WorkspaceFile", "WorkspaceFileList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Secret) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("security.databricks.m.crossplane.io", "v1beta1", "SecretScope", "SecretScopeList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *UserInstanceProfile) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.InstanceProfileIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("security.databricks.m.crossplane.io", "v1beta1", "User", "UserList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
