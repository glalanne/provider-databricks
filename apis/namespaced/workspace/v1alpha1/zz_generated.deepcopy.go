...
func (in *GitCredentialInitParameters) DeepCopyInto(out *GitCredentialInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]GitCredentialProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GitCredentialObservation) DeepCopyInto(out *GitCredentialObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]GitCredentialProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GitCredentialParameters) DeepCopyInto(out *GitCredentialParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]GitCredentialProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GlobalInitScriptInitParameters) DeepCopyInto(out *GlobalInitScriptInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]GlobalInitScriptProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GlobalInitScriptObservation) DeepCopyInto(out *GlobalInitScriptObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]GlobalInitScriptProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GlobalInitScriptParameters) DeepCopyInto(out *GlobalInitScriptParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]GlobalInitScriptProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MicrosoftTeamsInitParameters) DeepCopyInto(out *MicrosoftTeamsInitParameters) {
	*out = *in
	if in.AppIDSecretRef != nil {
		in, out := &in.AppIDSecretRef, &out.AppIDSecretRef
		*out = new(v1.LocalSecretKeySelector)
		**out = **in
	}
	if in.AppIDSet != nil {
		in, out := &in.AppIDSet, &out.AppIDSet
		*out = new(bool)
		**out = **in
	}
	...
	if in.AuthSecretSet != nil {
		in, out := &in.AuthSecretSet, &out.AuthSecretSet
		*out = new(bool)
		**out = **in
	}
	if in.ChannelURLSecretRef != nil {
		in, out := &in.ChannelURLSecretRef, &out.ChannelURLSecretRef
		*out = new(v1.LocalSecretKeySelector)
		**out = **in
	}
	if in.ChannelURLSet != nil {
		in, out := &in.ChannelURLSet, &out.ChannelURLSet
		*out = new(bool)
		**out = **in
	}
	...
	if in.TenantIDSet != nil {
		in, out := &in.TenantIDSet, &out.TenantIDSet
		*out = new(bool)
		**out = **in
	}
	if in.URLSecretRef != nil {
...
func (in *NotebookInitParameters) DeepCopyInto(out *NotebookInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]NotebookProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NotebookObservation) DeepCopyInto(out *NotebookObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]NotebookProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NotebookParameters) DeepCopyInto(out *NotebookParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]NotebookProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NotificationDestinationInitParameters) DeepCopyInto(out *NotificationDestinationInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]NotificationDestinationProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NotificationDestinationObservation) DeepCopyInto(out *NotificationDestinationObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]NotificationDestinationProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NotificationDestinationParameters) DeepCopyInto(out *NotificationDestinationParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]NotificationDestinationProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RepoInitParameters) DeepCopyInto(out *RepoInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]RepoProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RepoObservation) DeepCopyInto(out *RepoObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]RepoProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RepoParameters) DeepCopyInto(out *RepoParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]RepoProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SlackInitParameters) DeepCopyInto(out *SlackInitParameters) {
	*out = *in
	if in.ChannelIDSecretRef != nil {
		in, out := &in.ChannelIDSecretRef, &out.ChannelIDSecretRef
		*out = new(v1.LocalSecretKeySelector)
		**out = **in
	}
	if in.ChannelIDSet != nil {
		in, out := &in.ChannelIDSet, &out.ChannelIDSet
		*out = new(bool)
		**out = **in
	}
	...
	if in.OauthTokenSet != nil {
		in, out := &in.OauthTokenSet, &out.OauthTokenSet
		*out = new(bool)
		**out = **in
	}
	if in.URLSecretRef != nil {
...
func (in *WorkspaceConfInitParameters) DeepCopyInto(out *WorkspaceConfInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]WorkspaceConfProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WorkspaceConfObservation) DeepCopyInto(out *WorkspaceConfObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]WorkspaceConfProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WorkspaceConfParameters) DeepCopyInto(out *WorkspaceConfParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]WorkspaceConfProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WorkspaceFileInitParameters) DeepCopyInto(out *WorkspaceFileInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]WorkspaceFileProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WorkspaceFileObservation) DeepCopyInto(out *WorkspaceFileObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]WorkspaceFileProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WorkspaceFileParameters) DeepCopyInto(out *WorkspaceFileParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]WorkspaceFileProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
