...
func (mg *MwsNccBinding) ResolveReferences( // ResolveReferences of this MwsNccBinding.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("deployment.databricks.m.crossplane.io", "v1beta1", "MwsNetworkConnectivityConfig", "MwsNetworkConnectivityConfigList")
		if err != nil {
...
func (mg *MwsNetworks) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.VPCEndpoints != nil {
		{
			m, l, err = apisresolver.GetManagedResource("deployment.databricks.m.crossplane.io", "v1beta1", "MwsVPCEndpoint", "MwsVPCEndpointList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
...
func (mg *MwsWorkspaces) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("deployment.databricks.m.crossplane.io", "v1beta1", "MwsCredentials", "MwsCredentialsList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("deployment.databricks.m.crossplane.io", "v1beta1", "MwsNetworks", "MwsNetworksList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("deployment.databricks.m.crossplane.io", "v1beta1", "MwsStorageConfigurations", "MwsStorageConfigurationsList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
