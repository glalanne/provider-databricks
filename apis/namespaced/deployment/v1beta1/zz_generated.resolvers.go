...
// ResolveReferences of this MwsNccBinding.
func (mg *MwsNccBinding) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &MwsNetworkConnectivityConfigList{},
			Managed: &MwsNetworkConnectivityConfig{},
		},
	})
	if err != nil {
...
func (mg *MwsNetworks) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.VPCEndpoints != nil {
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			...
			To: reference.To{
				List:    &MwsVPCEndpointList{},
				Managed: &MwsVPCEndpoint{},
			},
		})
		if err != nil {
...
func (mg *MwsWorkspaces) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &MwsCredentialsList{},
			Managed: &MwsCredentials{},
		},
	})
	if err != nil {
	...
	rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
		...
		To: reference.To{
			List:    &MwsStorageConfigurationsList{},
			Managed: &MwsStorageConfigurations{},
		},
	})
	if err != nil {
