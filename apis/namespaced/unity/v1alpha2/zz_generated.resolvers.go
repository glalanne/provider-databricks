...
func (mg *CatalogWorkspaceBinding) ResolveReferences( // ResolveReferences of this CatalogWorkspaceBinding.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("unity.databricks.m.crossplane.io", "v1alpha2", "Catalog", "CatalogList")
		if err != nil {
...
func (mg *ExternalLocation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("unity.databricks.m.crossplane.io", "v1alpha2", "StorageCredential", "StorageCredentialList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Grant) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("unity.databricks.m.crossplane.io", "v1alpha2", "Credential", "CredentialList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("unity.databricks.m.crossplane.io", "v1alpha2", "ExternalLocation", "ExternalLocationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("unity.databricks.m.crossplane.io", "v1alpha2", "Connection", "ConnectionList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("unity.databricks.m.crossplane.io", "v1alpha2", "Schema", "SchemaList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("sharing.databricks.m.crossplane.io", "v1alpha2", "Share", "ShareList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("unity.databricks.m.crossplane.io", "v1alpha2", "Volume", "VolumeList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *MetastoreAssignment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("unity.databricks.m.crossplane.io", "v1alpha2", "Metastore", "MetastoreList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
