...
// ConvertTo converts this ModelServing to the hub type.
func (tr *ModelServing) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the ModelServing type.
func (tr *ModelServing) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
