...
type MwsWorkspacesInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/cluster/deployment/v1beta1.MwsCredentials
	...
	// +kubebuilder:validation:Optional
	CredentialsIDRef *v2.Reference `json:"credentialsIdRef,omitempty" tf:"-"`

	// Selector for a MwsCredentials in deployment to populate credentialsId.
	// +kubebuilder:validation:Optional
	CredentialsIDSelector *v2.Selector `json:"credentialsIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/cluster/deployment/v1beta1.MwsNetworks
	...
	// +crossplane:generate:reference:type=github.com/glalanne/provider-databricks/apis/cluster/deployment/v1beta1.MwsStorageConfigurations
	...
	// +kubebuilder:validation:Optional
	StorageConfigurationIDRef *v2.Reference `json:"storageConfigurationIdRef,omitempty" tf:"-"`

	// Selector for a MwsStorageConfigurations in deployment to populate storageConfigurationId.
	// +kubebuilder:validation:Optional
	StorageConfigurationIDSelector *v2.Selector `json:"storageConfigurationIdSelector,omitempty" tf:"-"`
...
type TokenInitParameters struct {
	...
	TokenValueSecretRef *v2.SecretKeySelector `json:"tokenValueSecretRef,omitempty" tf:"-"`
}
