...
func (mg *Alert) ResolveReferences( // ResolveReferences of this Alert.
	...
	{
		m, l, err = apisresolver.GetManagedResource("sql.databricks.crossplane.io", "v1beta1", "Query", "QueryList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *SQLWidget) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("sql.databricks.crossplane.io", "v1beta1", "SQLVisualization", "SQLVisualizationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
