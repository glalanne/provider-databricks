...
func (in *ProviderInitParameters) DeepCopyInto(out *ProviderInitParameters) {
	*out = *in
	...
	in.RecipientProfileStrSecretRef.DeepCopyInto(&out.RecipientProfileStrSecretRef)
}
...
func (in *RecipientInitParameters) DeepCopyInto(out *RecipientInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]RecipientProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RecipientObservation) DeepCopyInto(out *RecipientObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]RecipientProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RecipientParameters) DeepCopyInto(out *RecipientParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]RecipientProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ShareInitParameters) DeepCopyInto(out *ShareInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]ShareProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ShareObservation) DeepCopyInto(out *ShareObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]ShareProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ShareParameters) DeepCopyInto(out *ShareParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]ShareProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ShareProviderConfigInitParameters) DeepCopyInto(out *ShareProviderConfigInitParameters) {
	*out = *in
	if in.WorkspaceID != nil {
		in, out := &in.WorkspaceID, &out.WorkspaceID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ShareProviderConfigInitParameters.
func (in *ShareProviderConfigInitParameters) DeepCopy() *ShareProviderConfigInitParameters {
	if in == nil {
		return nil
	}
	out := new(ShareProviderConfigInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ShareProviderConfigObservation) DeepCopyInto(out *ShareProviderConfigObservation) {
	*out = *in
	if in.WorkspaceID != nil {
		in, out := &in.WorkspaceID, &out.WorkspaceID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ShareProviderConfigObservation.
func (in *ShareProviderConfigObservation) DeepCopy() *ShareProviderConfigObservation {
	if in == nil {
		return nil
	}
	out := new(ShareProviderConfigObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ShareProviderConfigParameters) DeepCopyInto(out *ShareProviderConfigParameters) {
	*out = *in
	if in.WorkspaceID != nil {
		in, out := &in.WorkspaceID, &out.WorkspaceID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ShareProviderConfigParameters.
func (in *ShareProviderConfigParameters) DeepCopy() *ShareProviderConfigParameters {
	if in == nil {
		return nil
	}
	out := new(ShareProviderConfigParameters)
	in.DeepCopyInto(out)
	return out
}
