...
func (in *DeltaSyncIndexSpecInitParameters) DeepCopyInto(out *DeltaSyncIndexSpecInitParameters) {
	*out = *in
	if in.ColumnsToIndex != nil {
		in, out := &in.ColumnsToIndex, &out.ColumnsToIndex
...
func (in *VectorSearchEndpointInitParameters) DeepCopyInto(out *VectorSearchEndpointInitParameters) {
	*out = *in
	...
	if in.ScalingInfo != nil {
		...
		*out = make([]ScalingInfoInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VectorSearchEndpointObservation) DeepCopyInto(out *VectorSearchEndpointObservation) {
	*out = *in
	...
	if in.ScalingInfo != nil {
		in, out := &in.ScalingInfo, &out.ScalingInfo
		*out = make([]ScalingInfoObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VectorSearchEndpointParameters) DeepCopyInto(out *VectorSearchEndpointParameters) {
	*out = *in
	...
	if in.ScalingInfo != nil {
		in, out := &in.ScalingInfo, &out.ScalingInfo
		*out = make([]ScalingInfoParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VectorSearchIndexInitParameters) DeepCopyInto(out *VectorSearchIndexInitParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]VectorSearchIndexProviderConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VectorSearchIndexObservation) DeepCopyInto(out *VectorSearchIndexObservation) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]VectorSearchIndexProviderConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VectorSearchIndexParameters) DeepCopyInto(out *VectorSearchIndexParameters) {
	*out = *in
	...
	if in.ProviderConfig != nil {
		in, out := &in.ProviderConfig, &out.ProviderConfig
		*out = make([]VectorSearchIndexProviderConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VectorSearchIndexProviderConfigInitParameters) DeepCopyInto(out *VectorSearchIndexProviderConfigInitParameters) {
	*out = *in
	if in.WorkspaceID != nil {
		in, out := &in.WorkspaceID, &out.WorkspaceID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VectorSearchIndexProviderConfigInitParameters.
func (in *VectorSearchIndexProviderConfigInitParameters) DeepCopy() *VectorSearchIndexProviderConfigInitParameters {
	if in == nil {
		return nil
	}
	out := new(VectorSearchIndexProviderConfigInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VectorSearchIndexProviderConfigObservation) DeepCopyInto(out *VectorSearchIndexProviderConfigObservation) {
	*out = *in
	if in.WorkspaceID != nil {
		in, out := &in.WorkspaceID, &out.WorkspaceID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VectorSearchIndexProviderConfigObservation.
func (in *VectorSearchIndexProviderConfigObservation) DeepCopy() *VectorSearchIndexProviderConfigObservation {
	if in == nil {
		return nil
	}
	out := new(VectorSearchIndexProviderConfigObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VectorSearchIndexProviderConfigParameters) DeepCopyInto(out *VectorSearchIndexProviderConfigParameters) {
	*out = *in
	if in.WorkspaceID != nil {
		in, out := &in.WorkspaceID, &out.WorkspaceID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VectorSearchIndexProviderConfigParameters.
func (in *VectorSearchIndexProviderConfigParameters) DeepCopy() *VectorSearchIndexProviderConfigParameters {
	if in == nil {
		return nil
	}
	out := new(VectorSearchIndexProviderConfigParameters)
	in.DeepCopyInto(out)
	return out
}
