...
// ConvertTo converts this MwsLogDelivery to the hub type.
func (tr *MwsLogDelivery) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the MwsLogDelivery type.
func (tr *MwsLogDelivery) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
